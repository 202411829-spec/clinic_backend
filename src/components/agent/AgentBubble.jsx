export default function AgentBubble({ isPending, open, onClick }) {
  ...
  return (
    <button
      ...
      onClick={onClick}
      className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-gc-green-700 text-white shadow-lg transition hover:bg-gc-green-800 focus:outline-none focus:ring-2 focus:ring-gc-green-700 focus:ring-offset-2 print:hidden"
    >
